"""
Django settings for Tradesperson project.
...
ROOT_URLCONF = 'Tradesperson.urls'
...
WSGI_APPLICATION = 'Tradesperson.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'Tradesperson/media')

LOGIN_REDIRECT_URL = 'base_layout'
LOGOUT_REDIRECT_URL = 'base_layout'
...
LEAFLET_CONFIG = {
    'DEFAULT_CENTER': (53.3703, -6.20727),
    'DEFAULT_ZOOM': 10,
    'MAX_ZOOM': 20,
    'MIN_ZOOM': 3,
    'SCALE': 'both',
